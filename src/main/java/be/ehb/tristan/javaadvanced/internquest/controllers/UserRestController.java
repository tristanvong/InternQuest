...
//
//    private String hardCodedPassword = "fdsqjm@@576lHKD";
//    private String hashedHardCodedPassword = null;
//
//    @Autowired
...
//        try {
//            System.out.println("Registering with PasswordEncoder: " + bCryptPasswordEncoder);
//            System.out.println();
//
//            System.out.println("NOT HASHED Hardcoded Password " + hardCodedPassword);
//            hashedHardCodedPassword = bCryptPasswordEncoder.encode(hardCodedPassword);
//            System.out.println("HASHED Hardcoded password: " + hardCodedPassword);
//            User user = new User();
...
//        System.out.println("logging in with PasswordEncoder: " + bCryptPasswordEncoder);
//        System.out.println();
//
//        boolean doesHardcodedMatch = (bCryptPasswordEncoder.matches(hardCodedPassword, hashedHardCodedPassword));
//        if (doesHardcodedMatch) {
//            System.out.println("Hardcoded password match");
//        } else {
//            System.out.println("Hardcoded password not match");
//        }
//        System.out.println();
//        try {
//            //dit werkt wel
...
////            }
//
//            boolean doesPasswordMatch = bCryptPasswordEncoder.matches(loginDTO.getPassword(), user.getPassword());
